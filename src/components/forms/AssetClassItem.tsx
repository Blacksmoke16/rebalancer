...
import { AssetClassNameInput, DeleteButton, FieldGroup, PercentageInput } from '../ui/FormFields';
...
export const AssetClassItem = memo<AssetClassItemProps>(function AssetClassItem({
    assetClass,
    assetIdx,
    form,
    onRemove,
    ...
    return (
        <Paper key={assetClass.key} withBorder p="md" className={classes.assetClassItem}>
