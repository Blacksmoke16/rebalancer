    ...
    return (
        <Text c={getDeltaColor(value)}>
            <NumberFormatter 
                ...
                thousandSeparator={type === 'currency' ? FORMATTING.THOUSAND_SEPARATOR : undefined}
                value={value}
                decimalScale={type === 'currency' ? FORMATTING.DECIMAL_PLACES.CURRENCY : FORMATTING.DECIMAL_PLACES.PERCENTAGE}
                allowNegative
            />
        </Text>
    );
