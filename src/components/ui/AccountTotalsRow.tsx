...
export const AccountTotalsRow = memo<AccountTotalsRowProps>(
  function AccountTotalsRow({ accounts }) {
    const {
      calculations: { totalForAccount, totalDollars },
    } = usePortfolioContext();
    ...
    return (
      <Fragment>
        ...
        <TableTr>
          <TableTd colSpan={2}>Account Totals</TableTd>
