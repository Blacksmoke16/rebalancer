...
export const DataManagement = memo<DataManagementProps>(function DataManagement({ onDataImported }) {
    ...
    const handleImport = useCallback(async () => {
        ...
        try {
            ...
            notifications.show({
                title: 'Import Failed',
                message: error instanceof Error ? error.message : 'Failed to import portfolio data',
                color: 'red',
            });
        } finally {
        ...
        <Paper shadow="xl" withBorder p="xl">
            ...
            <Stack mt="md">
                ...
                <Alert color="orange" title="Important">
                    <Text size="sm">
                        Importing data will replace all current accounts, asset classes, and fund values.
                        Make sure to export your current data first if you want to keep it.
                    </Text>
                </Alert>

                <div>
                    <Title order={5} c="red">Clear All Data</Title>
                    <Text size="sm" c="dimmed" mb="xs">
