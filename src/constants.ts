...
export const VALIDATION_MESSAGES = {
    ...
    STORAGE_QUOTA_EXCEEDED: 'Storage quota exceeded. Please clear some browser data or export your portfolio data as backup.',
    INVALID_PORTFOLIO_DATA: 'Invalid portfolio data found in localStorage, using defaults',
    ...
    CLEAR_DATA_CONFIRMATION: 'Are you sure you want to clear all data? This action cannot be undone. Consider exporting your data first.',
} as const;
