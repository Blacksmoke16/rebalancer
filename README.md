...
- **Planning Mode**: Plan complex transactions before applying them, including:
  - Rebalancing between funds (sell overweight, buy underweight)
  - Planning future contributions (annual IRA contributions, etc.)
  - Mixed scenarios (rebalance while adding new money)
  - Real-time balance tracking to ensure transactions offset correctly
